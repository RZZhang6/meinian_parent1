...
public class TestQiniu {
    ...
    public void uploadFile(){
        ...
        //...生成上传凭证，然后准备上传
        String accessKey = "HZw4Gf78pc-1T2tX_Lv9WSQtN2X74I1tAnNX7tt4";
        String secretKey = "PN1F6MygLT76GElxmRhh6YeV8hbw28MRXY0uni3r";
        String bucket = "atguigumeinian-0001";
        //如果是Windows情况下，格式是 D:\\qiniu\\test.png，可支持中文
        String localFilePath = "G:\\学习资料\\java\\atguigu\\temp\\meinv.jpeg";
