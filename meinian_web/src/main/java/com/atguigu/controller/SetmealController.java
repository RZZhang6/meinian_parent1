...
public class SetmealController {
    ...
    //   axios.post("/setmeal/findPage.do", paramData).then((resp)=>{
    ...
    //axios.post("/setmeal/add.do?travelgroupIds=" + this.travelItemIds, this.formData)
    @RequestMapping("/add")
    ...
    public Result upload(@RequestParam("imgFile") MultipartFile file) {
        try {
            ...
            int index = originalFilename.lastIndexOf("."); //xxxx.jpg
            ...
            //3.5 将上传图片名称存入Redis，基于Redis的Set集合存储
